using newDay_project23.Models;
using newDay_project23.Data;
using newDay_project23.Filter;
using newDay_project23.Entities;
using newDay_project23.Logger;
...
namespace newDay_project23.Services
{
    /// <summary>
    ...
    {
        private readonly newDay_project23Context _dbContext;
        ...
        public RoleEntitlementService(newDay_project23Context dbContext, IFieldMapperService mapper)
        {
