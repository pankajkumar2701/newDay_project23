...
using newDay_project23.Entities;

namespace newDay_project23.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class newDay_project23Context : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-GFUVFUP;Initial Catalog=T238325_newDay_project23;Persist Security Info=True;user id=pankazz;password=123456;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
