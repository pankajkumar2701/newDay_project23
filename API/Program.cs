...
using newDay_project23.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "newDay_project23", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<newDay_project23Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "newDay_project23 API v1");
